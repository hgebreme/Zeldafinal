...
// counter, determines when different actions occur
int movecount = 0;
...
Link link(6, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, "empty", 12, NULL, 1, 1, true, 0, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 40, 40, 6);
