...
Link::Link(int h=0, int x=0, int y=0, int px=0, int py=0, string path=NULL, int n=0, SDL_Rect* sp=NULL, int f=0, int pf=0, bool a=true, int dir=0, int sx=0, int sy=0, int sw=0, int sh=0){
    setHealth(h);
    setXPos(x);
    setYPos(y);
    setPrevXPos(px);
