...
SDL_Rect gDungeonClip; // select which region of dungeon to load
        ...
        if( !loadMedia() ){
            ...
            while( !quit ){
                ...
                if(xpos >= SCREEN_WIDTH - stretch.w){
                    switch(num){
                        case 0:
                            ...
                            break;
                        case 1:
                            xpos -= SPEED; // if in quadrant 1, it cannot move to the right so move back so it is still on the screen
                            break;
                        case 2:
                            num = 3;
                            xpos = 0;
                            break;
                        case 3:
                            xpos -= SPEED; // cannot move to the right anymore
                            break;
                        case 4:
                            xpos -= SPEED;
                            break;
                    ...
                    switch(num){
                        case 0:
                            xpos += SPEED; // move link back into range
                            break;
                        case 1:
                            ...
                            break;
                        case 2:
                            xpos += SPEED; // move link back into screen
                            break;
                        case 3:
                    ...
                    switch(num){
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            ypos -= SPEED; // move back into screen
                            break;
                        case 3:
                            ypos -= SPEED; // move back into screen
                            break;
                ...
                if(num == 0){ // starting zone
                    ...
                    SDL_RenderCopy(gRenderer, gDungeonTexture.texture(), &gDungeonClip, &fullScreen);
                }
